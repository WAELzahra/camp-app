...
CREATE TABLE `admin_wallet_transactions` (
  ...
  `category` enum('platform_fee','commission','platform_cancellation_fee','refund_funding') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `annonces` (
  ...
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Summer Camp',
  ...
  `status` enum('pending','approved','rejected','canceled','modified','archived') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `badges` (
  ...
  `type` enum('certification','reputation') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `camping_centres` (
  ...
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'centre',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `camping_zones` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nom` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type_activitee` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `terrain` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `access_type` enum('road','trail','boat','mixed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `contact_website` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `danger_level` enum('low','moderate','high','extreme') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'low',
  `is_beginner_friendly` tinyint(1) NOT NULL DEFAULT '0',
  `terrain_type` enum('forest','mountain','desert','coastal','plain','wetland') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `weather_station_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_weather_update` timestamp NULL DEFAULT NULL,
  `source` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'interne',
...
CREATE TABLE `cancellation_policies` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `type` enum('centre','materiel','event') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `centre_claims` (
  ...
  `proof_document` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `circuits` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `adresse_debut_circuit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `adresse_fin_circuit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `distance_km` double(8,2) NOT NULL,
  `estimation_temps` double(8,2) NOT NULL,
  `difficulty` enum('facile','moyenne','difficile') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `danger_level` enum('low','moderate','high','extreme') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'low',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `conversations` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `type` enum('direct','group') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `custom_commission_rule_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `custom_commission_rule_users` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `custom_commission_rule_users_rule_id_user_id_unique` (`rule_id`,`user_id`),
  KEY `custom_commission_rule_users_user_id_index` (`user_id`),
  CONSTRAINT `custom_commission_rule_users_rule_id_foreign` FOREIGN KEY (`rule_id`) REFERENCES `custom_commission_rules` (`id`) ON DELETE CASCADE,
  CONSTRAINT `custom_commission_rule_users_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `custom_commission_rules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `custom_commission_rules` (
  ...
  `commission_rate` decimal(5,2) NOT NULL COMMENT 'Override rate in percent (e.g. 3.5 = 3.5%)',
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `email_verifications` (
  ...
  `method` enum('code','link') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'code',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `event_reservation_materials`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `event_reservation_materials` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `event_reservation_id` bigint unsigned NOT NULL,
  ...
  `platform_fee_rate` decimal(5,2) NOT NULL DEFAULT '0.00',
  `supplier_net_revenue` decimal(10,2) NOT NULL DEFAULT '0.00',
  `supplier_credited` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `event_reservation_materials_event_reservation_id_index` (`event_reservation_id`),
  KEY `event_reservation_materials_supplier_id_index` (`supplier_id`),
  KEY `event_reservation_materials_materielle_id_index` (`materielle_id`),
  CONSTRAINT `event_reservation_materials_event_reservation_id_foreign` FOREIGN KEY (`event_reservation_id`) REFERENCES `reservations_events` (`id`) ON DELETE CASCADE,
  CONSTRAINT `event_reservation_materials_materielle_id_foreign` FOREIGN KEY (`materielle_id`) REFERENCES `materielles` (`id`) ON DELETE CASCADE,
  CONSTRAINT `event_reservation_materials_supplier_id_foreign` FOREIGN KEY (`supplier_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `event_reservation_services`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `event_reservation_services` (
  ...
  `pricing_unit_snapshot` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `subtotal` decimal(10,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `event_reservation_services_event_reservation_id_foreign` (`event_reservation_id`),
  KEY `event_reservation_services_event_service_id_foreign` (`event_service_id`),
  CONSTRAINT `event_reservation_services_event_reservation_id_foreign` FOREIGN KEY (`event_reservation_id`) REFERENCES `reservations_events` (`id`) ON DELETE CASCADE,
  CONSTRAINT `event_reservation_services_event_service_id_foreign` FOREIGN KEY (`event_service_id`) REFERENCES `event_services` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `event_services` (
  ...
  `pricing_unit` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `events` (
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `event_type` enum('camping','hiking','voyage','custom') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'camping',
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `capacity` int DEFAULT NULL,
  `price` decimal(8,2) NOT NULL DEFAULT '0.00',
  `remaining_spots` int DEFAULT NULL,
  `camping_duration` int DEFAULT NULL,
  `camping_gear` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `is_group_travel` tinyint(1) NOT NULL DEFAULT '0',
  `departure_city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `arrival_city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `departure_time` time DEFAULT NULL,
  `estimated_arrival_time` time DEFAULT NULL,
  `bus_company` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bus_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `city_stops` json DEFAULT NULL,
  `difficulty` enum('easy','moderate','difficult','expert') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `status` enum('pending','scheduled','ongoing','finished','canceled','postponed','full') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `views_count` int NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `expenses` (
  ...
  `categorie` enum('transport','hébergement','nourriture','équipement','marketing','maintenance','salaires','location','formation','communication','assurance','autre') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'autre',
  `status` enum('brouillon','confirmé','remboursé') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'confirmé',
...
CREATE TABLE `favorites` (
  ...
  `favoritable_type` enum('profile','centre','zone','equipment','annonce') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `feedbacks` (
  ...
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'groupe',
  `status` enum('pending','approved','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `materielles` (
  ...
  `condition` enum('new','like_new','good','fair') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'new',
  ...
  `status` enum('up','down') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'up',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `messages` (
  ...
  `type` enum('text','image','file','system','event_invitation') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'text',
...
CREATE TABLE `notification_logs` (
  ...
  `status` enum('sent','delivered','failed','opened') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'sent',
...
CREATE TABLE `notifications` (
  ...
  KEY `notifications_notifiable_read_at_index` (`notifiable_id`,`read_at`),
  CONSTRAINT `notifications_sender_id_foreign` FOREIGN KEY (`sender_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `organizer_supplier_links`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `organizer_supplier_links` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `organizer_supplier_links_organizer_id_supplier_id_unique` (`organizer_id`,`supplier_id`),
  KEY `organizer_supplier_links_organizer_id_index` (`organizer_id`),
  KEY `organizer_supplier_links_supplier_id_index` (`supplier_id`),
  KEY `organizer_supplier_links_status_index` (`status`),
  CONSTRAINT `organizer_supplier_links_organizer_id_foreign` FOREIGN KEY (`organizer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `organizer_supplier_links_supplier_id_foreign` FOREIGN KEY (`supplier_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `password_reset_tokens` (
  ...
  `expires_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`email`),
  KEY `prt_expires_at_index` (`expires_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `payments` (
  ...
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('pending','paid','failed','refunded_partial','refunded_total') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `konnect_session_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `konnect_payment_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `konnect_payment_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `photos` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `path_to_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` bigint unsigned DEFAULT NULL,
...
CREATE TABLE `platform_cancellation_fees` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `actor_type` enum('camper','centre','group','supplier') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `platform_settings` (
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type` enum('boolean','string','json','integer') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'string',
...
CREATE TABLE `popups` (
  ...
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('info','warning','promotion','update') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'info',
  `popup_kind` enum('engagement','welcome') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'engagement',
...
CREATE TABLE `profile_campeurs` (
  ...
  `skill_level` enum('beginner','intermediate','advanced','expert') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'beginner',
  `comfort_level` enum('basic','standard','glamping') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'standard',
  `budget_range` enum('budget','moderate','premium') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'moderate',
...
CREATE TABLE `profile_center_equipment` (
  ...
  `type` enum('toilets','drinking_water','electricity','parking','wifi','showers','security','kitchen','bbq_area','swimming_pool') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `profile_centres` (
  ...
  `legal_document` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `document_legal_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `profile_centres_profile_id_unique` (`profile_id`),
...
CREATE TABLE `profile_fournisseurs` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `profile_id` bigint unsigned NOT NULL,
  `intervale_prix` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_category` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `profile_groupes` (
  ...
  `patente_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `profile_guides` (
  ...
  `zone_travail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `certificat_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `certificat_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `profiles` (
  ...
  `type` enum('campeur','guide','centre','fournisseur','groupe') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `city` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `is_public` tinyint(1) NOT NULL DEFAULT '1',
  `cin_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `promo_codes` (
  ...
  `applicable_to` enum('all','centre','materiel','event') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'all',
...
CREATE TABLE `refund_requests` (
  ...
  `payment_channel` enum('konnect','wallet') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'konnect',
  `reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('en_attente','accepté','refusé') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en_attente',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `reports` (
  ...
  `report_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'other',
  `target_type` enum('user','center','group','supplier','zone','platform') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'platform',
  `target_id` bigint unsigned DEFAULT NULL,
  ...
  `status` enum('pending','reviewing','resolved') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `reservation_service_items` (
  ...
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status` enum('pending','approved','rejected','canceled','modified') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `rejected_by` enum('center','user') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `reservations_centres` (
  ...
  `group_skill_level` enum('beginner','intermediate','advanced','mixed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `trip_purpose` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('pending','approved','rejected','canceled','modified') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `payments_id` bigint unsigned DEFAULT NULL,
  `total_price` decimal(10,2) DEFAULT NULL,
  `payment_method` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'card',
  `service_count` int NOT NULL DEFAULT '0',
  `canceled_by` enum('user','center') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `canceled_at` timestamp NULL DEFAULT NULL,
  `cancellation_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `last_modified_by` enum('center','user') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `res_centres_status_index` (`status`),
  KEY `res_centres_user_status_index` (`user_id`,`status`),
  KEY `res_centres_date_range_index` (`date_debut`,`date_fin`),
...
CREATE TABLE `reservations_events` (
  ...
  `nbr_place` int NOT NULL,
  `payment_id` bigint unsigned DEFAULT NULL,
  `status` enum('en_attente_paiement','confirmée','en_attente_validation','refusée','annulée_par_utilisateur','annulée_par_organisateur','remboursement_en_attente','remboursée_partielle','remboursée_totale') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en_attente_paiement',
  `created_by` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `promo_code_id` bigint unsigned DEFAULT NULL,
  `discount_amount` decimal(10,2) NOT NULL DEFAULT '0.00',
  `payment_method` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'wallet',
  `platform_fee_amount` decimal(10,2) DEFAULT NULL,
  `platform_fee_rate` decimal(5,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `res_events_status_index` (`status`),
  KEY `res_events_user_status_index` (`user_id`,`status`),
...
CREATE TABLE `reservations_materielles` (
  ...
  `user_id` bigint unsigned NOT NULL,
  `fournisseur_id` bigint unsigned NOT NULL,
  `type_reservation` enum('location','achat') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_debut` date DEFAULT NULL,
  `date_fin` date DEFAULT NULL,
  `quantite` int unsigned NOT NULL,
  `montant_total` double(8,2) NOT NULL,
  `mode_livraison` enum('pickup','delivery') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `adresse_livraison` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `frais_livraison` double(8,2) DEFAULT '0.00',
  `cin_camper` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('pending','confirmed','paid','retrieved','returned','rejected','cancelled_by_camper','cancelled_by_fournisseur','disputed') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  `admin_pin_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `admin_pin_used_at` timestamp NULL DEFAULT NULL,
  `payment_id` bigint unsigned DEFAULT NULL,
  ...
  KEY `res_mat_status_index` (`status`),
  KEY `res_mat_user_status_index` (`user_id`,`status`),
...
CREATE TABLE `service_categories` (
  ...
  `unit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'person/night',
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `signales` (
  ...
  `status` enum('pending','validated','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
CREATE TABLE `supplier_invitations` (
  ...
  `status` enum('pending','registered','expired','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `supplier_invitations_token_unique` (`token`),
  KEY `supplier_invitations_supplier_id_foreign` (`supplier_id`),
  KEY `supplier_invitations_organizer_id_index` (`organizer_id`),
  KEY `supplier_invitations_email_index` (`email`),
  KEY `supplier_invitations_token_index` (`token`),
  CONSTRAINT `supplier_invitations_organizer_id_foreign` FOREIGN KEY (`organizer_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `supplier_invitations_supplier_id_foreign` FOREIGN KEY (`supplier_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `wallet_transactions` (
  ...
  `category` enum('reservation_payment','reservation_income','refund_out','refund_in','withdrawal','deposit','admin_credit','admin_debit') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  KEY `wallet_tx_created_at_index` (`created_at`),
...
CREATE TABLE `withdrawal_requests` (
  ...
  `user_id` bigint unsigned NOT NULL,
  `montant` decimal(12,2) NOT NULL,
  `status` enum('en_attente','en_cours','approuvé','complété','rejeté') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en_attente',
  `methode` enum('virement_bancaire','chèque','espèces','flouci') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'virement_bancaire',
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (107,'2026_05_10_000001_add_provider_fields_to_users_table',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (108,'2026_05_14_000001_add_type_activitee_to_camping_zones_table',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (109,'2026_05_14_172825_add_unique_profile_id_to_profile_centres',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (110,'2026_05_15_000001_add_security_performance_indexes',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (111,'2026_05_15_000002_add_uuid_to_users_table',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (112,'2026_05_15_change_description_to_text_in_materielles',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (113,'2026_05_16_000001_add_admin_pin_to_reservations_materielles',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (114,'2026_05_16_210523_add_admin_categories_to_wallet_transactions',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (115,'2026_05_17_000001_add_telephone_to_camping_centres_table',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (116,'2026_05_17_000002_add_is_partner_to_camping_centres_table',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (117,'2026_05_22_000001_update_group_role_to_organizer',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (118,'2026_05_22_000002_create_organizer_supplier_links_table',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (119,'2026_05_22_000003_create_supplier_invitations_table',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (120,'2026_05_22_000004_create_event_reservation_materials_table',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (121,'2026_05_23_000001_create_custom_commission_rules_tables',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (122,'2026_05_23_133247_add_custom_to_event_type_enum',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (123,'2026_05_23_133922_make_events_optional_columns_nullable',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (124,'2026_05_25_100000_create_event_services_table',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (125,'2026_05_25_100001_create_event_reservation_services_table',11);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (126,'2026_06_04_000001_relax_nbr_place_check_in_reservations_centres',11);
