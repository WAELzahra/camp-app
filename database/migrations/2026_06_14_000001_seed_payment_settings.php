    ...
    public function up(): void
    {
        ...
        $rows = [
            [
                ...
                'value'       => '',
                'label'       => 'Flouci Payment Link',
                'description' => 'External Flouci link shown to campers for manual bank transfer.',
                'type'        => 'string',
                'group'       => 'payment',
                'created_at'  => $now,
                'updated_at'  => $now,
            ...
            [
                ...
                'description' => 'Master switch — disable to hide the Flouci payment option from all booking flows.',
                'type'        => 'boolean',
                'group'       => 'payment',
                'created_at'  => $now,
                'updated_at'  => $now,
