...
class ReservationServiceItemSeeder extends Seeder
{
    ...
    {
        $serviceItems = [
            // Reservation 1 (Basic Camping + Breakfast)
            [
                'reservation_id' => 8,
            ...
            [
                ...
                'unit' => 'person',
                'quantity' => 3,
                'subtotal' => 60.00, // 3 people × 20.00 × 1 breakfast per day? Let's assume 1 day
                'service_date_debut' => Carbon::now()->subDays(10)->format('Y-m-d'),
                'service_date_fin' => Carbon::now()->subDays(7)->format('Y-m-d'),
            ...
            // Reservation 3 (Multiple services)
            [
                'reservation_id' => 10,
                'profile_center_service_id' => 1, // Basic Camping
                'service_name' => 'Basic Camping',
            ...
            [
                ...
                'unit' => 'night',
                'quantity' => 1,
                'subtotal' => 80.00, // 1 cabin for 1 night (maybe for grandparents)
                'service_date_debut' => Carbon::now()->addDays(15)->format('Y-m-d'),
