...
class RichDataSeeder extends Seeder
{
    ...
    private function seedWalletTransactions(Carbon $now): void
    {
        $rows = [
            ...
            ['user_id' => 3, 'related_user_id' => null, 'type' => 'credit', 'category' => 'deposit',             'amount_gross' => 100.00, 'commission_rate' => 0.00, 'commission_amount' => 0.00,  'net_amount' => 100.00, 'reference_type' => null, 'reference_id' => null, 'description' => 'Rechargement portefeuille via ClicToPay'],
