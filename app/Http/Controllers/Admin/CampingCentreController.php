...
use App\Http\Requests\Admin\AddPhotosRequest;
use App\Http\Requests\Admin\AssignZonesRequest;
use App\Http\Requests\Admin\LinkUserRequest;
use App\Http\Requests\Admin\NearbyCentresRequest;
use App\Http\Requests\Admin\StoreCampingCentreRequest;
use App\Http\Requests\Admin\UpdateCampingCentreRequest;
use App\Http\Requests\Admin\UpdateProfileCentreFromAdminRequest;
...
class CampingCentreController extends Controller
{
     ...
     */
    public function store(StoreCampingCentreRequest $request)
    {
        $request->validated();
     ...
     */
    public function assignZones(AssignZonesRequest $request, $centreId)
    {
        $request->validated();
     ...
     */
    public function updateProfileCentre(UpdateProfileCentreFromAdminRequest $request, $id)
    {
    ...
    // centres à proximité
    public function nearby(NearbyCentresRequest $request)
    {
     ...
     */
    public function linkUser(LinkUserRequest $request, $id)
    {
        $request->validated();
